...
.get('/CountNbOriginaleCharacterByName/:id', Character.CountNbOriginaleCharacterByName)
...
.post('/GetOriginalCharacterByName/:id', Character.GetOriginalCharacterByName)
